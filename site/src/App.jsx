...
const ECOSYSTEMS = [
  ...
  {
    id: "eco-jvm",
    language: "Java, JVM & Swift — opt-in",
    summary:
      "Three build tools whose recoverability proof is the manifest itself: a build tree is regenerated by recompiling the sources sitting next to it, not by downloading.",
    rows: [
      {
        name: "Gradle",
        detect: (
    ...
    tieBreak: (
      <>
        ...
        not a download — so these three ship disabled and invisible.{" "}
        <code>devp config set enable_gradle true</code> /{" "}
        <code>enable_maven true</code> / <code>enable_swift true</code> turns them
        on, and their candidates wait
