...
| Asset | Rust target |
|---|---|
| `dev-prune-v1.13.0-windows-x64.zip` | `x86_64-pc-windows-msvc` |
| `dev-prune-v1.13.0-windows-arm64.zip` | `aarch64-pc-windows-msvc` |
| `dev-prune-v1.13.0-windows-x86.zip` | `i686-pc-windows-msvc` |
| `dev-prune-v1.13.0-darwin-x64.tar.gz` | `x86_64-apple-darwin` |
| `dev-prune-v1.13.0-darwin-arm64.tar.gz` | `aarch64-apple-darwin` |
| `dev-prune-v1.13.0-linux-x64.tar.gz` | `x86_64-unknown-linux-musl` |
| `dev-prune-v1.13.0-linux-arm64.tar.gz` | `aarch64-unknown-linux-musl` |
...
```bash
gh attestation verify dev-prune-v1.13.0-linux-x64.tar.gz --repo Life-Experimentalist/dev-prune
```
